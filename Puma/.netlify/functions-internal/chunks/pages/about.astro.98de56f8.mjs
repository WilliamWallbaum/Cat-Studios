...
const $$PostLinks = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../pages/posts/post-1.md": () => import('./post-1.md.7ee8a822.mjs').then(n => n.p),"../pages/posts/post-2.md": () => import('./post-2.md.11b27446.mjs'),"../pages/posts/post-3.md": () => import('./post-3.md.f3f3f9d6.mjs'),"../pages/posts/post-4.md": () => import('./post-4.md.f5f1b872.mjs')}), () => "../pages/posts/*.md");
